...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Bandwith = Bandwith = 22e6

        ##################################################
        # Blocks
        ##################################################
        self._Frequency_range = Range(1.000e6, 433e6, 1e3, 433e6, 200)
        ...
        self.osmosdr_sink_0.set_if_gain(2, 0)
        self.osmosdr_sink_0.set_bb_gain(2, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1e6, 1, 0, 0)
        self._Bandwith_range = Range(1.5e6, 28e6, 1000, 22e6, 200)
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(2.4e9, self.sample_rate)
